...
import { ArrowRight, Heart, Users, Utensils, DollarSign } from 'lucide-react'
import { HOME, BRAND } from '../config/site.config'
import VolunteerDashboard from '../components/VolunteerDashboard'

// ─── PHOTO GALLERY ────────────────────────────────────────────────────────────
// Placeholder gallery — swap src values for real image paths in /public/images/
const GALLERY_IMAGES = [
  { src: null, alt: 'Community fridge stocked with fresh produce', label: 'Austin Market Fridge' },
  ...
  { src: null, alt: 'Community fridge on South Austin street',       label: 'South Austin Fridge' },
]

function GalleryPlaceholder({ alt, label }) {
  return (
    <div className="aspect-square bg-gradient-to-br from-brand-100 to-brand-200
                    ...
                    border-2 border-brand-200 overflow-hidden group
...
export default function Home() {
  return (
    <>
        ...
        <div className="section-container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 text-lg">
              Real neighbors making a real difference — every day, across Austin.
            </p>
          </div>
          {/* Gallery grid — replace placeholder items with real images */}
      ...
      {/* ── GET INVOLVED CTA ──────────────────────────────────────────── */}
      <section
        className="bg-brand-600 text-white section-py"
